...
func (h *handler) updateEntry(w http.ResponseWriter, r *http.Request) {
	...
	entryRequest := &model.EntryUpdateRequest{
		URL:    model.SetOptionalField(entryForm.URL),
		Title:  model.SetOptionalField(entryForm.Title),
		Author: model.SetOptionalField(entryForm.Author),
		Date:   model.SetOptionalField(date),
		Tags:   entryForm.Tags,
	}
